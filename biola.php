...
<body>
	...
	<div id="page-title">
		...
		<div id="page-title-inner">
			...
			<div class="container">
				...
				<h2><i class="ico-stats ico-white"></i>Biola</h2>
	...
	<div id="wrapper">
        ...
        <!--<div class="title"><h3>Keranjang Anda</h3></div>
            ...
            <div class="row">
            	<?php
            	$sql = mysqli_query($koneksi, "SELECT * FROM produk INNER JOIN harga ON harga.kode = produk.kode INNER JOIN stock ON stock.kode = produk.kode WHERE jenis='biola'");
            	if(mysqli_num_rows($sql) == 0){
					...
					<div class="clear">
						...
						<a href="detailproduk.php?hal=detailbarang&kd=<?php 
						echo $data['kode'];?>" class="btn btn-lg btn-danger">Details</a> 
