              ...
              <div class="form-panel">
                <form class="form-horizontal style-form" action="update-produk.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
                  <div class="form-group">
                    ...
                    <div class="col-sm-8">
                      <input name="kode" type="text" id="kode" value="<?php echo $row['kode']; ?>" class="form-control" autocomplete="off" placeholder="Kode Produk"/>
                    </div>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-3">
                      <select id="jenis" name="jenis" class="form-control" required>
                        <option value="bass" <?php if ($row['jenis'] == "Bass"){ echo "selected"; } ?>>Bass</option>
                        <option value="biola" <?php if ($row['jenis'] == "Biola"){ echo "selected"; } ?>>Biola</option>
                        <option value="drum" <?php if ($row['jenis'] == "Drum"){ echo "selected"; } ?>>Drum</option>
                        <option value="gitar" <?php if ($row['jenis']== "Gitar"){ echo "selected"; } ?>>Gitar</option>
                        <option value="harmonika" <?php if ($row['jenis'] == "Harmonika"){ echo "selected"; } ?>>Harmonika</option>
                        <option value="piano" <?php if ($row['jenis'] == "Piano"){ echo "selected"; } ?>>Piano</option>
                        <option value="pianika" <?php if ($row['jenis'] == "Pianika"){ echo "selected"; } ?>>Pianika</option> 
                      </select>
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-3">
                     <select id="nama_supplier" name="nama_supplier" class="form-control" value="<?php echo $row['nama_supplier']; ?>" required>
                      <?php 
                      $sql = mysqli_query($koneksi,"SELECT * FROM supplier");
                      while ($result = mysqli_fetch_array($sql)) {
                        ?>
                        <option value="<?php echo $result['nama_supplier'] ?>"><?php echo $result['nama_supplier']?></option>
                      <?php } ?>
                    </select>
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-3">
                    <input name="harga_beli" type="text" id="harga_beli" value="<?php echo $row['harga_beli']; ?>" class="form-control" autocomplete="off" placeholder="Harga Beli" autocomplete="off" required />
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-3">
                    <input name="harga_jual" type="text" id="harga_jual" value="<?php echo $row['harga_jual']; ?>" class="form-control" autocomplete="off" placeholder="Harga Jual" autocomplete="off" required />
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-3">
                    <input name="stok" type="text" id="stok" value="<?php echo $row['stok']; ?>" class="form-control" autocomplete="off" placeholder="Stock Barang" autocomplete="off" required />
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-3">
                    <input name="keterangan" type="text" id="keterangan" value="<?php echo $row['keterangan']; ?>" class="form-control" autocomplete="off" placeholder="Username" autocomplete="off" required />
