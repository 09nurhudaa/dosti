        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
			...
			?>
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Data PO Proses</li>
                    </ol>
                </section>
	       ...
	       <input type='text' class="form-control" style="margin-bottom: 4px;" name='qcari' placeholder='Cari No PO & Status' required /> 
           <input type='submit' value='Cari Data' class="btn btn-sm btn-primary" /> <a href='po.php' class="btn btn-sm btn-success" >Refresh</i></a>
          	</div>
              </div>
           <!-- /.row -->
                    <br />
                  ...
                  <thead>
                      <tr>
                        ...
                        <th><center>No Resi</i></center></th>
                        <th><center>Tanggal Kirim </center></th>
                        <th><center>Tanggal Sampai </center></th>
                    ...
                    <td><center><?php echo $data['no_resi'];?></center></td>
                    <td><center><?php echo $data['tanggalkirim'];?></center></td>
                    <td><center><?php echo $data['tanggal_sampai'];?></center></td>
                    <td><center><?php
                    ...
                    <td><center><div id="thanks">
                        <a class="btn btn-sm btn-success" data-placement="bottom" data-toggle="tooltip" title="Detail Pembayaran" href="detail-po.php?hal=detail&kd=<?php echo $data['nopo'];?>"><span class="glyphicon glyphicon-search"></span></a>
                        <a class="btn btn-sm btn-primary" data-placement="bottom" data-toggle="tooltip" title="Edit PO" href="edit-po.php?hal=edit&kode=<?php echo $data['nopo'];?>"><span class="glyphicon glyphicon-edit"></span></a>  
