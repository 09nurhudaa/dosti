            ...
            <div class="col-lg-12">
                <div class="panel panel-success">
                    <div class="panel-heading">
                        <h3 class="panel-title"><i class="fa fa-user"></i> Detail Data Supplier </h3> 
                    </div>
                    <div class="panel-body">
                      <div class="form-panel">
                          <table id="example" class="table table-hover table-bordered">
                            ...
                            <tr>
                              <td>Nama Supplier</td>
                              <td colspan="1"><?php echo $data['nama_supplier']; ?></td>
                          </tr>
                            <tr>
                              <td width="250">Alamat</td>
                              <td width="565" colspan="1"><?php echo $data['alamat']; ?></td>
                          </tr>
                          <tr>
                              <td>Nomor Telepon</td>
                              <td colspan="1"><?php echo $data['no_telp']; ?></td>
                          </tr>
                      </table>
                      <div class="text-right">
                          <a href="supplier.php" class="btn btn-sm btn-warning">Kembali <i class="fa fa-arrow-circle-right"></i></a>
