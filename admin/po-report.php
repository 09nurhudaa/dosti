...
<?php } ?>
        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
            ...
            Tanggal Awal: <input type="text" class="input-group date form-control" data-date="" data-date-format="yyyy-mm-dd" id="awal" name="awal" required />
            Tanggal Akhir: <input type="text" class="input-group date form-control" data-date="" data-date-format="yyyy-mm-dd" id="akhir" name="akhir" required />
            <br>
	       <!-- <input type='text' class="form-control" style="margin-bottom: 4px;" name='qcari' placeholder='Cari No PO & Kode Customer' required />  -->
           <input type='submit' value='Cari Data' class="btn btn-sm btn-primary" /> <a href='po-report.php' class="btn btn-sm btn-success" >Refresh</i></a> <a href='cetak-po1.php?awal=<?php echo isset($_POST['awal']) ? $_POST['awal'] : null; ?>&akhir=<?php echo isset($_POST['akhir']) ? $_POST['akhir'] : null; ?>' class="btn btn-sm btn-success" target="_blank"><i class="fa fa-print"></i>&nbsp;Print All</i></a>
          	</div>
              </div>
           <!-- /.row -->
                    <br />
	               ...
	               // $qcari=$_POST['qcari'];
                    ...
                    $akhir = $_POST['akhir'];
	               $query1="SELECT * FROM  po_terima 
	               where DATE(tanggal) BETWEEN DATE('$awal') AND DATE('$akhir')";
                    }
                  ...
                  <thead>
                    ...
                    <td><center><div id="thanks"><a class="btn btn-sm btn-success" data-placement="bottom" data-toggle="tooltip" title="Cetak PO" href="cetak-po.php?hal=cetak&kd=<?php echo $data['id'];?>" target="_blank"><span class="glyphicon glyphicon-print"></span></a> </div>
                 <?php   
              } 
              ?>
                   </tbody>
