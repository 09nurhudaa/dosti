      ...
      <div class="wrapper row-offcanvas row-offcanvas-left">
        ...
        <aside class="right-side">
          ...
          <section class="content">
           ...
           <!-- Main row -->
           <?php
           $query = mysqli_query($koneksi, "SELECT * FROM supplier WHERE kode_supplier='$_GET[kd]'");
            ...
            <div class="col-lg-12">
              <div class="panel panel-success">
                <div class="panel-heading">
                  <h3 class="panel-title"><i class="fa fa-user"></i>Edit Data Supplier </h3> 
                </div>
                <div class="panel-body">
                  <div class="form-panel">
                    <form class="form-horizontal style-form" action="update-supplier.php" 
                    method="post" name="form1" id="form1">
                      <div class="form-group">
                        <label class="col-sm-2 col-sm-2 control-label">Kode Supplier</label>
                        <div class="col-sm-10">
                          <input name="kode_supplier" type="text" id="kode_supplier" class="form-control" value="<?php echo $data['kode_supplier'];?>" readonly="readonly" autofocus="on" />
                        </div>
                      </div>
                      <div class="form-group">
                        <label class="col-sm-2 col-sm-2 control-label">Nama Supplier</label>
                        <div class="col-sm-10">
                          <input name="nama_supplier" type="text" id="nama_supplier" class="form-control" value="<?php echo $data['nama_supplier'];?>" required />
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-10">
                          <input name="no_telp" class="form-control" id="no_telp" type="text" 
                          value="<?php echo $data['no_telp'];?>" required />
                        </div>
                      </div>
                      <div class="form-group">
                        <label class="col-sm-2 col-sm-2 control-label">Gambar Supplier</label>
                        <div class="col-sm-10">
