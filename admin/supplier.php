...
if (empty($_SESSION['username'])){
    ...
    <head>
        <meta charset="UTF-8">
        <title>Halaman Admin DOSTI</title>
                        ...
                        <ul class="dropdown-menu">
                            ...
                            if (isset($_SESSION['start_time'])) {
                                ...
                                if ($elapsed_time >= $timeout) {
                                    session_destroy();
                                    echo "<script>alert('Session Anda Telah Habis!'); 
                        ...
                        <div class="panel-body">
                         <!-- <div class="table-responsive"> -->
                            ...
                            if(isset($_POST['qcari'])){
                                $qcari=$_POST['qcari'];
                                $query1="SELECT * FROM  supplier 
                                where kode_supplier like '%$qcari%'
                                or nama_supplier like '%$qcari%'  ";
                            }
                            ...
                            <table id="example" class="table table-hover table-bordered">
                              <thead>
                                  <tr>
                                    ...
                                    <th><center>Kode_supplier </center></th>
                                    <th><center>Nama_supplier </center></th>
                                ...
                                { $no++; ?>
                                    <tbody>
                                        <tr>
                                            ...
                                            <td><center><?php echo $data['kode_supplier'];?></center></td>
                                            <td>
                                            <center>
                                            <a href="detail-supplier.php?hal=edit&kd=<?php echo $data['kode_supplier'];?>"><span class="glyphicon glyphicon-user"></span> 
                                            ...
                                            <td>
                                                <center>
                                                    <div id="thanks">
                                                        <a class="btn btn-sm btn-primary" data-placement="bottom" data-toggle="tooltip" title="Edit Supplier" href="edit-supplier.php?hal=edit&kd=<?php echo $data['kode_supplier'];?>">
                                                            <span class="glyphicon glyphicon-edit">
                                                            </span>
                                                        </a>  
                                                        <a onclick="return confirm ('Yakin hapus <?php echo
                                                        $data['nama_supplier'];?>.?');" class="btn btn-sm btn-danger tooltips" data-placement="bottom" data-toggle="tooltip" title="Hapus Admin" 
                                                        href="hapus-supplier.php?hal=hapus&kd=<?php echo $data['kode_supplier'];?>">
                            ...
                            <div class="text-right">
                              <a href="input-supplier.php" class="btn btn-sm btn-warning">
                                Tambah Supplier 
