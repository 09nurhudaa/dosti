           ...
           <!-- /.row -->
                  ...
                  <div class="form-panel">
                      <form class="form-horizontal style-form" action="update-po.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
                          ...
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">No Resi</label>
                              <div class="col-sm-3">
                            <input name="no_resi" type="text" id="no_resi" value="<?php echo $row['no_resi']; ?>" class="form-control" autocomplete="off" />
                            </div>
                          </div>
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Tanggal Kirim</label>
                              <div class="col-sm-3">
                            <input type="text" class="input-group date form-control" data-date="" data-date-format="yyyy-mm-dd" id="tanggalkirim" name="tanggalkirim" value="<?php echo $row['tanggalkirim']; ?>" required />
                            </div>
                          ...
                          <div class="form-group">
                                <label class="col-sm-2 col-sm-2 control-label">Tanggal Sampai</label>
                                <div class="col-sm-3">
                                <input type="text" class="input-group date form-control" data-date="" data-date-format="yyyy-mm-dd" id="tanggal_sampai" name="tanggal_sampai" value="<?php echo $row['tanggal_sampai']; ?>" required />
                            </div>
                             <label class="col-sm-2 col-sm-2 control-label">Tanggal Sampai Sebelumnya</label>
                              <div class="col-sm-3">
                            <span class="label label-success"><?php echo $row['tanggal_sampai']; ?></span>
                            </div>
                            </div>                                
                            <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Bukti Kirim</label>
                              <div class="col-sm-3">
