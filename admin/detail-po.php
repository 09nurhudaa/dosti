        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
           ...
           <!-- /.row -->
                    ...
                    <div class="panel panel-success">
                        ...
                        <h3 class="panel-title"><i class="fa fa-user"></i> Data Sales Order </h3> 
                        </div>
                        <?php
                    ...
                    <td rowspan="9"><div class="pull-right image">
                            <img src="<?php echo $data['bukti_kirim']; ?>" class="img-rounded" height="300" width="250" alt="User Image" style="border: 3px solid #333333;" />
                        </div></td>
                    </tr>
                    <tr>
                    <td width="250">No Resi</td>
                    <td width="550"><?php echo $data['no_resi']; ?></td>
                    </tr>
                    <tr>
                    <td>Tanggal Kirim</td>
                    ...
                    <td><?php
                            if($data['status'] == 'Selesai'){
								echo '<span class="label label-success">Barang sudah dalam pengiriman.</span>';
							}
                            else if ($data['status'] == 'Proses' ){
								echo '<span class="label label-danger">Sedang proses gudang</span>';
							}
                    ?></td>
                    </tr>
                   </table>
                ...
                <a href="po.php" class="btn btn-sm btn-warning"> Kembali <i class="fa fa-arrow-circle-right"></i></a>
                </div>  
                </div> 
              </div>
            </div><!-- col-lg-12--> 
