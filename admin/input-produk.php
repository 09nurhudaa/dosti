...
if (empty($_SESSION['username'])){
  ...
  include "../conn.php";
  $query = mysqli_query($koneksi, "SELECT max(kode) as kodeTerbesar FROM produk");
...
if (!empty($_FILES["nama_file"]["tmp_name"]))
{
  ...
  {     
    ...
    if (move_uploaded_file($_FILES['nama_file']['tmp_name'], $gambar)) {
      $sql="INSERT INTO produk(kode,nama,jenis,nama_supplier,keterangan,gambar) VALUES
      ('$kode','$nama','$jenis','$nama_supplier','$keterangan','$gambar')";
      $res=mysqli_query($koneksi, $sql) or die (mysqli_error());
      $sql1="INSERT INTO harga(kode,harga_jual, harga_beli) VALUES
      ('$kode','$harga_jual','$harga_beli')";
      $res=mysqli_query($koneksi, $sql1) or die (mysqli_error());
       $sql2="INSERT INTO stock(kode,stok) VALUES
      ('$kode','$stok')";
        ...
        <div class="form-panel">
          <form class="form-horizontal style-form" action="input-produk.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
            <div class="form-group">
              ...
              <div class="col-sm-8">
                <input name="kode" type="text" id="kode" class="form-control" autocomplete="off" 
                placeholder="Kode Produk" value="<?php echo $kodeBarang ?>" readonly />
              </div>
            </div>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-3">
              ...
              <select id="jenis" name="jenis" class="form-control" required>
                ...
                <option value="bass">Bass</option> <!-- weist bag -->
                <option value="biola">Biola</option> <!-- weist bag -->
                <option value="drum">Drum</option> <!-- topi -->
                <option value="gitar">Gitar</option> <!-- Kaos -->
                <option value="harmonika">Harmonika</option> <!-- ransel -->
                <option value="Piano">Piano</option> <!-- ransel -->
                <option value="pianika">Pianika</option> <!-- ransel -->
          ...
          <div class="form-group">
            ...
            <div class="col-sm-3">
              <input name="harga_beli" type="text" id="harga_beli" class="form-control" autocomplete="off" placeholder="Harga Beli Produk" autocomplete="off" required />
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-3">
              <input name="harga_jual" type="text" id="harga_jual" class="form-control" autocomplete="off" placeholder="Harga Jual Produk" autocomplete="off" required />
            </div>
          </div>
