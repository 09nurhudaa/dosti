...
<div class="wrapper row-offcanvas row-offcanvas-left">
    ...
    <aside class="right-side">
        ...
        <section class="content-header">
            <h1>Sales Order<small>Administrator</small></h1>
            <?php
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Data SO Terima</li>
    </ol>
</section>
        ...
        <div class="col-lg-12">
            <div class="panel panel-success">
                <div class="panel-heading">
                    <h3 class="panel-title"><i class="fa fa-user"></i> Data SO Terima</h3> 
                </div>
