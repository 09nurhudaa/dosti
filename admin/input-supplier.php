                      ...
                      <section class="sidebar">
                        ...
                        <div class="user-panel">
                          <div class="pull-left image">
                            <img src="<?php echo $_SESSION['gambar']; ?>" class="img-circle" 
                            alt="User Image" style="border: 2px solid #3C8DBC;" />
                          </div>
                          ...
                          <div class="panel panel-success">
                            ...
                            <div class="panel-body">
                              <div class="form-panel">
                                <form class="form-horizontal style-form" action="insert-supplier.php" 
                                method="post" enctype="multipart/form-data" name="form1" id="form1">
                                  <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                      <input name="kode_supplier" type="text" id="kode_supplier" 
                                      class="form-control" placeholder="Kode Supplier" autofocus="off" required />
                                    </div>
                                  </div>
                                  <div class="form-group">
                                    <label class="col-sm-2 col-sm-2 control-label">Nama Supplier</label>
                                    <div class="col-sm-10">
                                      <input name="nama_supplier" type="text" id="nama_supplier" 
                                      class="form-control" placeholder="Nama Supplier" autocomplete="off" required />
                                  ...
                                  <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                      ...
                                      class="form-control" placeholder="Alamat" autocomplete="off" 
                                      required />
                                    </div>
                                  </div>
                                  <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                      <input name="no_telp" class="form-control" id="no_telp" 
                                      type="text" placeholder="Nomor Telepon" autocomplete="off" 
                                      required />
                                    </div>
                                  </div>
                                  <div class="form-group">
