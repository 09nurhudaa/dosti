          ...
          <div class="row">
            ...
            <div class="col-lg-4">
              <form action='produk.php' method="POST">
                ...
                <input type='text' class="form-control" style="margin-bottom: 4px;" name='qcari' placeholder='Cari Nama & Jenis Produk' required /> 
                ...
                <div class="panel panel-success">
                  ...
                  <div class="panel-body">
                   <!-- <div class="table-responsive"> -->
                    <?php
                    $query1="select * from produk INNER JOIN harga ON harga.kode = produk.kode INNER JOIN stock ON stock.kode = produk.kode";
                    ...
                    <table id="example" class="table table-hover table-bordered">
                      <thead>
                        <tr>
                          ...
                          <th><center>Kode Produk </i></center></th>
                        ...
                        { $no++; ?>
                          <tbody>
                            <tr>
                              ...
                              <td><a href="detail-produk.php?hal=edit&kd=<?php echo $data['kode'];?>"><span class="glyphicon glyphicon-tag"></span> 
                              ...
                              <td>
                                <center>
                                  <div id="thanks">
                                    <a class="btn btn-sm btn-primary" data-placement="bottom" data-toggle="tooltip" title="Edit Produk" href="edit-produk.php?hal=edit&kd=<?php echo $data['kode'];?>">
                                <span class="glyphicon glyphicon-edit">
                                </span>
                              </a>  
                              <a onclick="return confirm ('Yakin hapus <?php echo $data['nama'];?>.?');" class="btn btn-sm btn-danger tooltips" data-placement="bottom" data-toggle="tooltip" title="Hapus Produk" href="hapus-produk.php?hal=hapus&kd=<?php echo $data['kode'];?>"><span class="glyphicon glyphicon-trash">
                                    </a>
                              </center>
                            </td>
                          </tr>
