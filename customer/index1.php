            ...
            <aside class="right-side">
                ...
                <!-- Main content -->
                  ...
                  <thead>
                    ...
                    <td><center><div id="thanks"><a class="btn btn-sm btn-danger" data-placement="bottom" data-toggle="tooltip" title="Cetak Invoice" href="cetak-po.php?hal=cetak&kd=<?php echo $data['id'];?>" target="_blank"><span class="glyphicon glyphicon-print"></span></a> 
                    <a class="btn btn-sm btn-success" data-placement="bottom" data-toggle="tooltip" title="Status PO" href="status-po.php?hal=status&kd=<?php echo $data['nopo'];?>"><span class="glyphicon glyphicon-search"></span></a> 
              ...
              ?>
                  ...
                  <!-- </div>-->
                   ...
                   <?php 
                        $sqlku = mysqli_query($koneksi, "SELECT * FROM bank 
                        ORDER BY id_bank DESC limit 1"); 
