...
$result=mysqli_query($koneksi, "SELECT po_terima.*, produk.nama, produk.harga, produk.keterangan,
...
while($row = mysqli_fetch_array($result))
{
	...
	$column_factor = $column_factor.$keterangan."\n";
...
$pdf->SetY($Y_Table_Position);
$pdf->SetX(90);
$pdf->MultiCell(40,6,$column_factor,1,'C');
