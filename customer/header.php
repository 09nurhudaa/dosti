		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="logo span3">
					...
					<a class="brand" href="index.php"><img src="../img/logo1.png" alt="Logo"></a>
			            		...
			            		<ul class="nav">
                                    ...
                                    <li class="dropdown">
			                			...
			                			<ul class="dropdown-menu">
			                  				...
			                  				<li><a href="biola.php">Biola</a></li>
			                  				<li><a href="drum.php">Drum</a></li>
			                  				<li><a href="gitar.php">Gitar</a></li>
			                  				<li><a href="harmonika.php">Harmonika</a></li>
			                  				<li><a href="pianika.php">Pianika</a></li>
