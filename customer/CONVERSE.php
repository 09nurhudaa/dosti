...
<head>
	...
	<meta charset="utf-8">
	<title>ECLOOTH</title> 
	<meta name="description" content="Website, Corporate, Bekasi, KONVEKSI"/>
	<meta name="keywords" content="KONVEKSI, KAOS, WEIST BAG, RANSEL, TOPI." />
	<!-- end: Meta -->
	...
	<div id="page-title">
		...
		<div id="page-title-inner">
			...
			<div class="container">
				...
				<h2><i class="ico-stats ico-white"></i>WEIST BAG</h2>
	...
	<div id="wrapper">
        ...
        <!--<div class="title"><h3>Keranjang Anda</h3></div>
            <div class="hero-unit">
      		...
      		<div class="row">
	<?php
                    $sql = mysqli_query($koneksi, "SELECT * FROM produk WHERE jenis='WEIST BAG' order by kode DESC");
