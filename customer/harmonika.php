...
<body>
	...
	<div id="page-title">
		...
		<div id="page-title-inner">
			...
			<div class="container">
				...
				<h2><i class="ico-stats ico-white"></i>Harmonika</h2>
	...
	<div id="wrapper">
		...
		<div class="container"> 
			...
			<div class="row">
				<?php
				$sql = mysqli_query($koneksi, "SELECT * FROM produk INNER JOIN harga ON harga.kode = produk.kode INNER JOIN stock ON stock.kode = produk.kode WHERE jenis='harmonika'");
